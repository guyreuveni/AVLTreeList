...
def interactive_tree():
    ...
    while True:
        choice = input(
            "choose an operation you want to do with your AVLTreeList from the following: \n \
        ...
        if choice == "exit":
            ...
            print(
                "if '"
                + str(index)
                + "' was a valid index, the "
                + str(index)
                + "'th item in the list is now '"
                + val
                + "'"
            )
            ...
            print(
                ...
                + "' was a valid index, the "
                + str(index)
                + "'th item in the list had been deleted"
            )
        elif choice == "first()":
            ...
            ans = input(
                "if you want to print the value of the "
                + str(index)
                + "'th index enter 'yes'\n\
                            enter your choice here:  "
            )
            ...
            if index == -1:
                ...
                print(val + " is in the " + str(index) + "'th index in your list")
        elif choice[:3] == "max":
            i = choice[4]
            j = choice[6]
            res = T.getMaxInRange(int(i), int(j))
            print("max in range (" + str(i) + "," + str(j) + ") is: " + str(res))
        else:
            print("please enter a valid input")
        ans = input(
